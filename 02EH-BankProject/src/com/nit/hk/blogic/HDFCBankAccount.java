...
public class HDFCBankAccount implements BankAccount {
	...
	public void init(BankAccountDetails accDetails) {
		...
		System.out.println("HDFCBankAccount object is initialized");
	}
	...
	public void deposit(double amt) throws InvalidAmountException {
		...
		balance = balance + amt;
		System.out.println(
				"deposit operation is done on HDFCBankAccount object");
	}
	...
	public void withdraw(double amt) throws InvalidAmountException, InsufficientFundsException {
		...
		balance = balance - amt; 
		System.out.println(
				"withdraw operation is done on HDFCBankAccount object");
	}
	...
	public void currentBalance() {
		...
		System.out.println(
				"currentBalance operation is done on HDFCBankAccount object");
	}
	...
	public void transferMoney(BankAccount destAcc, double amt)
		...
		destAcc.deposit(amt);
		System.out.println(
				"Money transferred from HDFCBankAccount object");
